          ...
          >
            ...
            <div className="md:w-1/2 relative">
              ...
              {project.images.length > 1 && (
                <>
                  <button onClick={handlePrev} class="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 p-2 sm:p-3
                  ...
                  <button onClick={handleNext} class="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2
            ...
            <div className="md:w-1/2 text-left space-y-4">
              <div className='flex flex-wrap items-center gap-2 sm:gap-4 mb-4'>
                <span class="px-2 sm:px-3 py-1 bg-blue-600/20 text-cyan-300 rounded-full text-xs
              ...
              <div className="bg-navy-800/30 backdrop-blur-sm rounded-xl p-4 mt-4 border border-blue-500/20">
                <div className='flex items-center gap-2 mb-3 sm:mb-4'>
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512"
                    class="text-cyan-400 text-sm sm:text-base" height="1em" width="1em"
                ...
                <ul className="space-y-2">
                  {project.features.map((feature, idx) => (
                    ...
                    className='flex items-start gap-3'>
                      <div class="w-1.5 h-1.5 bg-cyan-400 rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div class="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-4">
                ...
                <a href="https://github.com/adeyemiiiii7/studymate" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 border-2 border-blue-400 text-blue-200 font-medium rounded-lg hover:bg-blue-500/10 transition duration-300 text-sm sm:text-base">
