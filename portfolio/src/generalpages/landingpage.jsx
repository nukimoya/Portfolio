...
const LandingPage = () => {
    ...
    <div className="landing-page">
        ...
        <div className='hero ' id='hero'>
            <h1>Samuel Adelakun</h1>

            <div>Building scalable systems that solve real problems. 
                Computer Science graduate with 2+ years of full-stack experience in 
                TypeScript, React, Node.js & Flutter. Passionate about cloud-native 
                development, AI-powered solutions, and crafting seamless digital experiences.
            </div>
        ...
        <div className="..." id='about'>
            ...
            <div className='grid grid-col-3'>
                <div className='col-span-1'>
                    <img src="path/to/your/profile.jpg" alt="Profile" className='w-32 h-32 rounded-full' />
                </div>
                <div className='col-span-2'>
                    ...
                    <p>
                        I am a software developer with a strong foundation
                         in full-stack development (React.js, Node.js, Flutter)
                          and a growing expertise in cloud computing. I enjoy building scalable, user-friendly
                           applications and optimizing backend systems for performance and efficiency.

                        I thrive in collaborative, fast-paced environments 
                        where I can solve real-world problems, contribute meaningful solutions,
                         and continue learning. My goal is to merge software development and cloud
                          computing to build robust, scalable systems that drive innovation.
                    </p>
            ...
            <div>
                ...
                <div className='grid grid-cols-3'>      
                    <div className='col-span-1'>
                        ...
                        <p>Passionate about AI, blockchain, and cloud computing, always
                            exploring emerging trends and their real-world impact.
                        </p>
                    </div>
                    <div className='col-span-1'>
                        <h4>Music</h4> 
                        <p>A fan of diverse genres that inspire creativity and enhance focus 
                            during development sessions.
                        </p>
                    </div>
                    <div className='col-span-1'>
                        <h4>Movies & history</h4> 
                        <p>Enjoy historical films, thrillers, and documentaries that explore 
                            significant events and untold stories.
                        </p>
                    </div>
                </div>
            </div>
