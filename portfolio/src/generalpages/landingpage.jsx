                    ...
                    <div className="space-y-6">
                        ...
                        <div className="w-12 h-12 bg-gradient-to-r from-red-500 to-orange-400 rounded-lg flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                            ...
                            className="text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 
                                92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 
                                132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 
                                85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z">
                                </path>
                            </svg>
                        </div>
                        <div>
                        ...
                        <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-400 rounded-lg flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                            ...
                            className="text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z">
                                </path>
                            </svg>
                        </div>
                        <div>
                        ...
                        <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-400 rounded-lg flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                            ...
                            className="text-2xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                <path d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192
                                192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 
                                80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z">
                                </path>
                            </svg>
                        </div>
                        <div>
                    ...
                    <form className="space-y-6" id="contact-form" ref={formRef} onSubmit={handleSubmit}>
                        <div className="grid sm:grid-cols-2 gap-6">
                            ...
                            <div className="relative">
                                <svg stroke="currentColor" fill="currentColor"  className="absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-400 text-sm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="1em" width="1em">
                            ...
                            <div className="relative">
                                <svg stroke="currentColor" fill="currentColor" className="absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-400 text-sm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="1em" width="1em">
